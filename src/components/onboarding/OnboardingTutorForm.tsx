...
import { onboardingTutorSchema } from "@/types/onboarding";
...
interface OnboardingTutorFormProps {
  onSubmit: (values: z.infer<typeof onboardingTutorSchema>) => void;
  onBack: () => void;
  isSubmitting?: boolean;
}

export function OnboardingTutorForm({
  onSubmit,
  onBack,
  isSubmitting = false,
}: OnboardingTutorFormProps) {
  const form = useForm<z.infer<typeof onboardingTutorSchema>>({
    resolver: zodResolver(onboardingTutorSchema),
    defaultValues: {
      bio: "",
